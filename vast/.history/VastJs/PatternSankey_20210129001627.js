...
function PaintRect(pattern_data) {
            d3.csv("data/box_calc_rank.csv").then((RectInDataR) => {
                    ...
                    Rect_g = svgMain.append('g').attr("transform", "translate(" + 0 + "," + 5 + ")")
                    ...
                    Rect_g.selectAll(".recta")
                        ...
                        .attr("y1", d => {
                            ...
                            if (d.rectcnt == 1) {
                                return height - padding.top + d.start * bei + 3 * steplen - 10;
                            }
                            ...
                            return height - padding.top + d.start * bei + d.n * tt - 10;
                        })
                        // .attr("rx", 5)
                        ...
                        .attr('y2', d => {
                            let tt = steplen;
                            if (d.rectcnt == 1) {
                                return height - padding.top + d.start * bei + 3 * steplen - 10 + (d.end - d.start) * bei;
                            }
                            // if (d.x == 0 || d.x == 1 || d.x == 10) {
                            if (d.rectcnt == 3) {
                                tt = 3 * steplen;
                            ...
                            return height - padding.top + d.start * bei + d.n * tt - 10 + (d.end - d.start) * bei;
                        })
                        .attr("stroke", d => {
                            return "black"
                        })
