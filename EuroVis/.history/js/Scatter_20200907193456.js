            ...
            for (let i in dicpos) {
                ...
                for (let j = 1; j <= 7; ++j) {
                    ...
                    for (let k = 0; k < 4; ++k) {
                        ...
                        if (dicpos[i].deci[k] > kmaxk) {
                            kmaxk = dicpos[i].deci[k];
                            kindex = k;
                        }
                    }
                    v.push((kindex + 1) * 10);
                ...
                kmain.push(Rader(kdata, Math.round(xScale(dicpos[i].x_avg), 5), Math.round(yScale(dicpos[i].y_avg), 5)));
