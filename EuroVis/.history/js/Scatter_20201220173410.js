        ...
        d3.csv('data/box_calc.csv').then((rectdata) => {
            ...
            for (let i in dicpos) {
                var temp1 = {
                    ...
                    target: {
                        x: diccircle[i].pos[0] + Math.cos(inScale(dicpos[i].wealthIn_avg)) * diccircle[i].dcnt + stepCirandBox * linescale(dicpos[i].cnt),
                        y: diccircle[i].pos[1] + Math.sin(inScale(dicpos[i].wealthIn_avg)) * diccircle[i].dcnt + stepCirandBox * linescale(dicpos[i].cnt)
                    },
                    cnt: diccircle[i].cnt
                }
                var temp2 = {
                ...
                if (dicpos[i].wealthOut_avg > 0) {
                    temp2.target.x += Math.cos(outScaleZheng(dicpos[i].wealthOut_avg)) * diccircle[i].dcnt - stepCirandBox * linescale(dicpos[i].cnt);
                    temp2.target.y += Math.sin(outScaleZheng(dicpos[i].wealthOut_avg)) * diccircle[i].dcnt - stepCirandBox * linescale(dicpos[i].cnt);
                }
                if (dicpos[i].wealthOut_avg <= 0) {
                    temp2.target.x += Math.cos(outScaleFu(dicpos[i].wealthOut_avg)) * diccircle[i].dcnt - stepCirandBox * linescale(dicpos[i].cnt);
                    temp2.target.y += Math.sin(outScaleFu(dicpos[i].wealthOut_avg)) * diccircle[i].dcnt - stepCirandBox * linescale(dicpos[i].cnt);
                }
                dicline.push(temp1);
                dicline.push(temp2);
            ...
            //         },
            //         target: {
            //             x: diccircle[i].pos[0] + Math.cos(inScale(dicpos[i].wealthIn_avg)) * diccircle[i].dcnt,
            //             y: diccircle[i].pos[1] + Math.sin(inScale(dicpos[i].wealthIn_avg)) * diccircle[i].dcnt
            //         },
            //         cnt: diccircle[i].cnt
            //     }
            // }
