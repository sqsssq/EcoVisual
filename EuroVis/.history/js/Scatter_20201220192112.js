...
function DrawGlyph() {
    d3.json(fileURL).then((gdata) => {
        d3.csv('data/box_calc.csv').then((rectdata) => {
            ...
            //         temp1.startAngle = outScaleZheng(dicpos[i].wealthOut_box[3]);
            //     } else {
            //         temp1.startAngle = outScaleFu(dicpos[i].wealthOut_box[3]);
            //     }
                
            //     if (dicpos[i].wealthOut_box[4] > 0) {
            //         temp1.endAngle = outScaleZheng(dicpos[i].wealthOut_box[4]);
            //     } else {
            //         temp1.endAngle = outScaleFu(dicpos[i].wealthOut_box[4]);
            //     }
            //     var temp3 = {
            //         startAngle: 0,
            //         endAngle: 0,
            ...
            //     }
            //     if (dicpos[i].wealthOut_box[1] > 0) {
            //         temp1.startAngle = outScaleZheng(dicpos[i].wealthOut_box[1]);
            //     } else {
            //         temp1.startAngle = outScaleFu(dicpos[i].wealthOut_box[1]);
            //     }
                
            //     if (dicpos[i].wealthOut_box[3] > 0) {
            //         temp1.endAngle = outScaleZheng(dicpos[i].wealthOut_box[3]);
            //     } else {
            //         temp1.endAngle = outScaleFu(dicpos[i].wealthOut_box[3]);
            //     }
            ...
            bubble_box_cur = ssvg.selectAll('#dicArc')
                ...
                .append('path')
                .attr('d', d => {
                    var carc = d3.arc().innerRadius(d.r - 0.1)
                        .outerRadius(d.r + 0.1);
                    var temp = {
