            ...
            for (let i in dicpos) {
                for (let j = 0; j < 5; ++j) {
                    ...
                    if (dicpos[i].wealthOut_box[j] > 0) {
                        temp2.target.x += Math.cos(outScaleZheng(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxstep * linescale(dicpos[i].cnt));
                        temp2.target.y += Math.sin(outScaleZheng(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxstep * linescale(dicpos[i].cnt));
                        temp2.targetAnglex = Math.cos(outScaleZheng(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxstep * linescale(dicpos[i].cnt));
                        temp2.targetAngley = Math.sin(outScaleZheng(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxstep * linescale(dicpos[i].cnt));
                    ...
                    if (dicpos[i].wealthOut_boxj <= 0) {
                        temp2.source.x += Math.cos(outScaleFu(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxandline * linescale(dicpos[i].cnt));
                        temp2.source.y += Math.sin(outScaleFu(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxandline * linescale(dicpos[i].cnt));
                        temp2.sourceAnglex += Math.cos(outScaleFu(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxandline * linescale(dicpos[i].cnt));
                        temp2.sourceAngley += Math.sin(outScaleFu(dicpos[i].wealthOut_box[j])) * (diccircle[i].dcnt - boxandline * linescale(dicpos[i].cnt));
