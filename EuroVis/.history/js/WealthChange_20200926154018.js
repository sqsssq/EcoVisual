...
function Paintjudge_sum() {
    // nam = name;
    d3.csv('data/box_calc.csv', function (vdata) {
        console.log(vdata);
        if (peo_g != 0) peo_g.remove();
        ...
        for (var select_name in name) {
            ...
            pie_data.push([])
            for (var d in vdata) {
                if (vdata[d].code == name[select_name]) {
                    pie_data[select_name].push(vdata[d])
                    p_ = {}
                    p_['name'] = name
                    p_['judge'] = [parseInt(vdata[d]['ability']), parseInt(vdata[d]['3']), parseInt(vdata[d]['4']), parseInt(vdata[d]['5']), parseInt(vdata[d]['6']), parseInt(vdata[d]['7']), parseInt(vdata[d]['8']), parseInt(vdata[d]['9']), parseInt(vdata[d]['10']), parseInt(vdata[d]['11'])]
                    p_['price'] = parseFloat(vdata[d]['129'])
                    if (p_max < parseFloat(vdata[d]['129'])) p_max = parseFloat(vdata[d]['129'])
                    if (p_min > parseFloat(vdata[d]['129'])) p_min = parseFloat(vdata[d]['129'])
                    p_['lun'] = vdata[d]['biao']
                    p_['sum'] = vdata[d]
                    p_data[select_name].push(p_)
                    // console.log(vdata[d])
            ...
            // console.log(vdata[d])
            // if (vdata[d].code == name[1]) {
            //     p_ = {}
            //     p_['name'] = name
            //     p_['judge'] = [parseInt(vdata[d]['1']), parseInt(vdata[d]['2']), parseInt(vdata[d]['3']), parseInt(vdata[d]['4']), parseInt(vdata[d]['5'])]
            //     p_['price'] = parseFloat(vdata[d]['91'])
            //     if (p_max < parseFloat(vdata[d]['91'])) p_max = parseFloat(vdata[d]['91'])
            //     if (p_min > parseFloat(vdata[d]['91'])) p_min = parseFloat(vdata[d]['91'])
            //     p_['lun'] = vdata[d]['biao']
            //     p1_data.push(p_)
            // }
        }
