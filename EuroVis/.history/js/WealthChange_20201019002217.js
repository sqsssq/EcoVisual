            ...
            d3.csv('data/treatment.csv').then(treatData => {
                ...
                for (let i in nameLineData) {
                    for (let j = 1; j < 20; ++j) {
                        ...
                        if (typeof (diaganlData[j * 1000000 + nameLineData[j] * 10000 + (j + 1) * 100 + nameLineData[j + 1]]))
                            diaganlData[j * 1000000 + nameLineData[j] * 10000 + (j + 1) * 100 + nameLineData[j + 1]] = 0;
                        diaganlData[j * 1000000 + nameLineData[j] * 10000 + (j + 1) * 100 + nameLineData[j + 1]]++;
                    }
                }
