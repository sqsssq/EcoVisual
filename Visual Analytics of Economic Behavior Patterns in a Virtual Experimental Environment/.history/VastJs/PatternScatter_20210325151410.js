...
function DrawAxis(scatter_data, flag) {
    d3.csv('data/newdata_for_line.csv').then((box_data) => {
        ...
        axis_g.append("g")
            .attr("transform", "translate(" + 10 + "," + (y_log_scale(Math.log10(0 + yScale(0)))) + ")")
            .call(d3.axisBottom(y_log_scale).ticks(10))
        // // .append("text")
        // // .attr("font-family", "Georgia")
        // // .attr('font-size', 15)
        // // .attr("dx", widthGantt - 30)
        ...
        // // .text("round");
        axis_g.append("g")
            .attr("transform", "translate(" + (y_log_scale(Math.log10((xScale(0))))) + "," + (0) + ")")
