...
$(document).ready(function () {
    $("#dbscan").click(function () {
        document.getElementById("binStart").disabled = true;
        document.getElementById("binProfit").disabled = true;
        document.getElementById("bin3").disabled = true;
        document.getElementById("bin4").disabled = true;
