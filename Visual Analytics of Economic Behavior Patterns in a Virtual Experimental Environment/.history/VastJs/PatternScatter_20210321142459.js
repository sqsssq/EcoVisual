    ...
    d3.csv('data/newdata_for_line.csv').then((box_data) => {
        ...
        axisCircle = axis_g.selectAll('#axisCircle')
            ...
            .on('click', d => {
                ...
                selectPeopleCircle(select_people_num + 1, d.nx, d.ny, fill, peo_cir.attr('cx'), peo_cir.attr('cy'), peo_cir.attr('fill'));
            });
...
function selectPeopleCircle(cnt, x, y, fill, dx, dy, fill_d) {
