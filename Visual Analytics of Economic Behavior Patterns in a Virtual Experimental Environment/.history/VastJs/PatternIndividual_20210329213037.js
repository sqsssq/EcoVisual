...
function drawPersonalHorizon(code, cnt, round) {
    d3.csv('data/newdata_for_line.csv').then(wealth_data => {
        ...
        pie_g.append('rect').attr('x', 5).attr('y', 10).attr('height', (heightFlower - 24) / 4 - 20).attr('width', widthHorizonMain - 30 - 10).attr('fill', 'none').attr('stroke', 'black').attr('stroke-width', 1);
    });
}
