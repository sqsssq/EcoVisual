...
const color_wealth = ['rgba(24,71,44, 1)', 'rgba(24,71,44, 0.7)', 'rgba(24,71,44, 0.4)', 'rgba(255,102,102, 0.4)', 'rgba(255,102,102, 0.7)', 'rgba(255,102,102, 1)'];
...
function flowerGlyph(pie_data, decisionList, max_gain) {
    ...
    const flowerScale = d3.scaleLinear()
        .domain([0, max_gain])
        .range([flower_inner + flower_outer / 4, flower_outer]);
...
function drawHorizonR(roundCount, max_num, move_x, move_y, compare_g, id) {
    ...
    let color_scale_2 = d3.scaleOrdinal()
        ...
        .range(['rgba(24,71,44, 1)', 'rgba(7, 151, 71, 0.7)', 'rgba(24,71,44, 0.4)']);
    var area_generator = d3.area()
        .x(function (d, i) {
            return x_scale(i + 1);
        })
