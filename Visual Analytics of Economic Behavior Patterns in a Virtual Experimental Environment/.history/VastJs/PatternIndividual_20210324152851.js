...
function drawWealthLine() {
    d3.csv('data/newdata_for_line.csv').then(wealth_data => {
        ...
        box_g.selectAll("#h_s_rect")
            ...
            .append("rect")
            .attr("x", d => {
                return this.x_scale_wealth(d.x);
            })
            .attr("y", d => {
                return this.y_scale_wealth(d.y);
            })
            .attr("width", d => {
                return this.x_scale_wealth(d.width);
            })
            .attr("height", d => {
        ...
        box_g.selectAll("#s_s")
            ...
            .append("line")
            .attr("x1", d => {
                return this.x_scale_wealth(d.x1) + d.flag == -1 ? -10 : 10;
            })
            .attr("y1", d => {
                return  this.y_scale_wealth(d.y1);
            })
            .attr("x2", d => {
                return this.x_scale_wealth(d.x2) + d.flag == -1 ? -10 : 10;
            })
            .attr("y2", d => {
