...
var lineLegendType = ['Work', 'Health Investment', 'Repayment', 'Loan', 'Investment', 'Venture', 'Insurance', 'Lottery', 'Disaster', 'Illness', 'Risk Preference', 'Patience'];
var lineNameLegend = [
        ...
        d3.csv('data/treatment.csv').then(treat => {
            ...
            for (let i = 0; i < lineLegend.length; ++i) {
                ...
                for (let j in selectData) {
                    ...
                    // if (i == 4)
                    // console.log(peopleHistory[selectData[j].id][selectData[j].lun][i].v)
