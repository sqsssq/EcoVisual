        ...
        d3.csv('data/treatment.csv').then(treat => {
            ...
            for (let i in selectData) {
                ...
                for (let j = 0; j < lx.length - 1; ++j) {
                    if (typeof(line_type_width[lx[i].x.toString() + lx[i].y.toString()]) == 'undefined') {
                        line_type_width[lx[i].x.toString() + lx[i].y.toString()] = {
                            x: lx[i].x,
                            y: lx[i].y,
                            w: 0
                        };
                    }
                    line_type_width[lx[i].x.toString() + lx[i].y.toString()].w++;
                }
            }
