        ...
        d3.csv('data/jingshouyi.csv').then((rect_data) => {
            d3.csv('data/box_calc_rank.csv').then((box_data) => {
                ...
                for (let i = 0; i < box_data.length; ++i) {
                    let temp = {
                        y: parseFloat(box_data[i]['79']) - parseFloat(box_data[i]['69']),
                ...
                let y_sum = Math.abs(y_min) + Math.abs(y_max);
                ...
                let x_axis_type = (0 - x_min) > 0 ? ((0 - x_min) / x_step == 8 ? 7 : (0 - x_min) / x_step) : -1;
                let y_axis_type = (0 - y_min) > 0 ? ((0 - y_min) / y_step == 8 ? 7 : (0 - y_min) / y_step) : -1;
