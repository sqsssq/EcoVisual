...
function DrawAxis(scatter_data, flag) {
    d3.csv('data/newdata_for_line.csv').then((box_data) => {
        ...
        axis_g.append("g")
            .attr("transform", "translate(" + 0 + "," + (y_log_scale(Math.log(0 + yScale(0)))) + ")")
            .call(d3.axisBottom(xScale).ticks(10))
        // // .append("text")
        // // .attr("font-family", "Georgia")
        // // .attr('font-size', 15)
        ...
        // // .text("round");
        axis_g.append("g")
            .attr("transform", "translate(" + (y_log_scale(Math.log((xScale(0))))) + "," + (0) + ")")
            .call(d3.axisLeft(yScale).ticks(10))
        // // .append("text")
        // // .attr("font-family", "Georgia")
        // // .attr('font-size', 15)
        ...
        axisCircle = axis_g.selectAll('#axisCircle')d
            .attr('id', 'axisCircle')
            .data(scatter_array)
            .enter()
            .append('circle')
