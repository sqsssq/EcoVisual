        ...
        pie_g
            ...
            .on('mouseover', d => {
                for (let i = 0; i < select_people_num; ++i) {
                    if (i != parseInt(d) - 1) {
                        d3.selectAll('#line' + i.toString()).attr('stroke-opacity', 0);
                        d3.selectAll('#cir' + i.toString()).attr('stroke-opacity', 0);
                        d3.selectAll('#flower' + i.toString()).attr('stroke-opacity', 0).attr('fill-opacity', 0);
                    }
                }
            });
