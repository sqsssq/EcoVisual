...
{
    const flower_inner = 50;
    const flower_outer = 100;
    ...
    .attr("transform", `translate(${this.x_scale_wealth(5), this.y_scale_wealth(300)}) rotate(-105, 0, 0)`);
    glyph_g.selectAll("#pie_glyph_graph")
