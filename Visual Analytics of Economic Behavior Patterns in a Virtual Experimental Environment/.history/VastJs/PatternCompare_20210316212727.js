        ...
        d3.csv('data/treatment.csv').then(treat => {
            ...
            for (let i = 0; i < lineLegend.length; ++i) {
                ...
                let line_scale_1 = d3.scaleLinear()
                    ...
                    .range([1, 100])
                if (i == 4) {
                    console.log(line_scale_1(0));
                }
                let line_scale_log = d3.scaleLinear()
                    .domain([0, 2])
                ...
                for (let j in selectData) {
                    ...
                    let r1 = line_scale_log(Math.log10(line_scale_1(peopleHistory[selectData[j].id][selectData[j].lun][i].v)));
                    // console.log(r1)
