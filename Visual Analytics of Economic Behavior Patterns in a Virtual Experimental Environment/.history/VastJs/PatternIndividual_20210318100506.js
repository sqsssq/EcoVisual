...
const heightHorizonView = document.getElementById('horizonView').offsetHeight;
const widthHorizonVIew = document.getElementById('horizonView').offsetWidth;
...
function drawColorLegend() {
    const svgFlower = d3.select('#horizonView')
        .append('svg')
        .attr('width', widthHorizonVIew - 30)
        .attr('height', 100)
