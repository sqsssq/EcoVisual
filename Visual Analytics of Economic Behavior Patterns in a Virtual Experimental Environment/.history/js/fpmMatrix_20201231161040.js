                ...
                for (let i = 0; i < data2.length; ++i) {
                    for (let j = 1  ; j < 6 - 1; ++j) {
                        ...
                        for (let k = j + 1; k < 6; ++k) {
                            ...
                            // if (typeof (typeSimilar2[(data2[i][j] + 1) * 10 + data2[i][k] + 1].cnt) == 'undefined')
                                console.log(data2[i][j] + 1, data2[i][k] + 1)
                            typeSimilar2[(data2[i][j] + 1) * 10 + data2[i][k] + 1].cnt++;
                        }
                    }
                }
                console.log(typeSimilar2);
