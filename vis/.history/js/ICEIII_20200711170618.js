        ...
        d3.csv('data/box_calc.csv', function (bdata) {
            ...
            for (let i in Cir_1) {
                ...
                ice_rect.selectAll('RLine_2')
                    ...
                    .append('line')
                    .attr('x1', (d, i) => {
                        let sita = StartAngle * Math.PI * 2 + i * 360 / 304 * Math.PI / 180;
            ...
            ice_rect.selectAll('RLine_1')
                ...
                .append('line')
                .attr('x1', (d, i) => {
                    let sita = i * 360 / 304 * Math.PI / 180;
            ...
            for (let i in Cir_2) {
                ...
                ice_rect.selectAll('RLine_2')
                    ...
                    .append('line')
                    .attr('x1', (d, i) => {
                        let sita = StartAngle2 * Math.PI * 2 + i * 360 / 304 * Math.PI / 180;
            ...
            for (let i in Cir_3) {
                ...
                ice_rect.selectAll('RLine_2')
                    ...
                    .append('line')
                    .attr('x1', (d, i) => {
                        let sita = (StartAngle3 - Cir_3[i].member.length / 304) * Math.PI * 2 + i * 360 / 304 * Math.PI / 180;
