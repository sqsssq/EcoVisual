...
var coso = ['#D3D3D3', '#D3D3D3', '#D3D3D3', '#D3D3D3']
...
function SunCir(num, lun) {
    d3.json('data/DK/' + num.toString() + '.json', function (idata) {
        d3.csv('data/box_calc.csv', function (bdata) {
            ...
            var arcc = d3.svg.arc()
                .innerRadius(10 + Redius_in / 2 - 5)
                .outerRadius(10 + Redius_in / 2 + 5)
            var arcr = d3.svg.arc()
                .innerRadius(10 + Redius_in / 2 + Redius_in - 5)
                .outerRadius(10 + Redius_in / 2 + Redius_in + 5)
            var arc_d = {
                startAngle: 0,
                endAngle: Math.PI * 2
            }
            ...
            var sss = 0;
            var arc3 = d3.svg.arc()
                .innerRadius(10 + Redius_in * 2 - 5 + Redius_in / 2)
                .outerRadius(10 + Redius_in * 2 + 5 + Redius_in / 2)
            for (let i in Cir_3) {
                if (Cir_3[i].tag) {
                    var arc_data1 = {
