...
function PaintBackground() {
    ...
    d3.csv('data/box_calcr.csv', function (data) {
        ...
        var xAxis = d3.svg.axis().scale(p_xscale).ticks(21).tickFormat(d3.format("d")).orient("bottom");
        ...
        for (let i = 1; i <= 20; ++i) {
            ...
            Box_Plot_data[i].sort()
            Box_Plot[i]['high'] = Box_Plot_data[i][Box_Plot_data.length - 1];
            Box_Plot[i]['midH'] = Box_Plot_data[i][Box_Plot_data.length * 3 / 4];
            Box_Plot[i]['mid'] = Box_Plot_data[i][Box_Plot_data.length / 2];
            Box_Plot[i]['midL'] = Box_Plot_data[i][Box_Plot_data.length * 1 / 4];
