...
function PaintUnderRect() {
    d3.csv("data/box_calc.csv", function (RectInData) {
        ...
        colorLine = ['rgb(213, 62, 79)', 'rgb(244, 109, 67)', 'rgb(253, 174, 97)', 'rgb(254, 224, 139)']
        let RectInnerData = []
        ...
        RectLine.selectAll(".rectLine")
                    ...
                    .attr("y", d => {
                        ...
                        return height - 200 + d.start * 0.01 + d.n * steplen + tt - 10;
                    })
                    // .attr("rx", 5)
                    .attr("width", 10)
                    .attr("height", d => {
                    ...
                    .attr("fill", d => {
                        ...
                        return colorLine(color_scale(parseInt(d.weight)))
                    })
    })
}
