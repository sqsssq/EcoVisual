        ...
        for (var i = 0; i <= 9; ++i) {
            ...
            for (var j in RectOuterData[i]) {
                ...
                for (var k in RectOuterData[i][j].member) {
                    let RD = RectOuterData[i][j].member[k];
                    if (typeof (p[(i - 1).toString() + RD[i].toString() + (i).toString() + RD[i + 1].toString()]) == "undefined") {
                        p[(i - 1).toString() + RD[i].toString() + (i).toString() + RD[i + 1].toString()] = 1;
                    } else
                        p[(i - 1).toString() + RD[i].toString() + (i).toString() + RD[i + 1].toString()]++;
                    // if (p[i.toString() + ])
                }
                s_num += RectOuterData[i][j].member.length
            }
