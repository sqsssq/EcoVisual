...
// 画连接线
var LinePaint = function (path, dia, color, num) {
    // console.log(path)
    ...
    var line_linear = d3.scale.linear()
        .domain([0, lg_line])
        .range([0, 39])
    Line_Name = Rect_g.selectAll(".line_r")
        .attr("class", "line_r")
        .data(path)
        .enter()
        .append("line")
        ...
        .attr("y1", (d, i) => {
            if (d.x1 != 0) {
                ...
                if (d.x1 == 9) {
                    console.log(d.y1 * bei + height - padding.top - 375 + d.n1 * tt - 10)
                }
    ...
    d3.csv("data/box.csv", function (d1) {
        ...
        d3.json('data/ScatterF.json', function (coork) {
            d3.csv("data/box_calc.csv", function (RectInData) {
                ...
                LinePaint(path[0], path[2], "black", num)
