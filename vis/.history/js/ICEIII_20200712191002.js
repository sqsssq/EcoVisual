    ...
    d3.json('data/DT/' + num.toString() + '.json', function (idata) {
        d3.csv('data/box_calc.csv', function (bdata) {
            ...
            for (let i in Cir_4) {
                ...
                var arc3 = d3.svg.arc()
                    .innerRadius((10 + Redius_in * 4 + Redius_in / 2 ))
                    .outerRadius(170)
                if (Cir_4[i].tag == 1) {
                    arc3 = d3.svg.arc()
            ...
            for (let i in Cir_1) {
                ...
                if (num == 5 && i == 0) {
                    ...
                    .attr('x1', (10 + Redius_in / 2) * Math.sin(sita) + width_ice / 2)
                    .attr('y1', (10 + Redius_in / 2) * Math.cos(sita) + (height_ice / 2 - 10))
                    .attr('x2', (10 + Redius_in * 4 + Redius_in / 2 ) * Math.sin(sita) + width_ice / 2)
                    .attr('y2', (10 + Redius_in * 4 + Redius_in / 2 ) * Math.cos(sita) + (height_ice / 2 - 10))
                    .attr('fill', 'none')
                    .attr('stroke-width', 3)
                    .attr('stroke', '#A9A9A9')
            }
            ...
            for (let i in Cir_2) {
                ...
                if ((num == 5 && i == 3) || (num == 3 && i == 2))
                    ...
                    .attr('x1', (10 + Redius_in * 1 + Redius_in / 2 ) * Math.sin(sita) + width_ice / 2)
                    .attr('y1', (10 + Redius_in * 1 + Redius_in / 2 ) * Math.cos(sita) + (height_ice / 2 - 10))
                    .attr('x2', ((10 + Redius_in) + 100) * Math.sin(sita) + width_ice / 2)
                    .attr('y2', (10 + Redius_in * 4 + Redius_in / 2 ) * Math.cos(sita) + (height_ice / 2 - 10))
                    .attr('fill', 'none')
                    .attr('stroke-width', 2)
                    .attr('stroke', '#A9A9A9')
