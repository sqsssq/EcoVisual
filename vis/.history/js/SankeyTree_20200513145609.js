...
function PaintDecisionLine(Decision, People) {
    d3.csv("data/box_calc.csv", function (RectInnerData) {
        ...
        for (var i in p) {
            ...
            b = {
                source: {
                    x: 15 + RectX[i[0] + i[1]].start * DecisionRectBei + RectX[i[0] + i[1]].n * tt + (RectX[i[0] + i[1]].end - RectX[i[0] + i[1]].start) * RisionRectBei,
                    y: 100 + RectX[i[0] + i[1]].x * 28 + 7.5
                },
                target: {
                    x: 15 + RectX[i[2] + i[3]].start * DecisionRectBei + RectX[i[2] + i[3]].n * tt + (RectX[i[2] + i[3]].end - RectX[i[2] + i[3]].start) * RisionRectBei
                }
            }
        }
    })
