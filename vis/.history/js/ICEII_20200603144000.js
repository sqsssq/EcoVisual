        ...
        for (var k = 0; k < 33; ++k) {
            ...
            p_g.selectAll('#linein')
                ...
                .attr('y1', d => {
                    ...
                    return (r[k].n + 1) * height_ice / (lxBei / 2) - height_ice / lxBei - height_ice / (lxBei / 4)
                })
                .attr('x2', (d, i) => {
                    // return i / 10;
                    var cnt = 0;
                ...
                .attr('y2', d => {
                    ...
                    return (r[k].n + 1) * height_ice / (lxBei / 2) - height_ice / (lxBei) - line_scale(Math.log2(Math.abs(parseFloat(d[129])))) / 2 - height_ice / (lxBei / 4)
                })
                .attr('fill', 'none')
                .attr('stroke', d => {
        ...
        for (var k = 0; k < 33; ++k) {
            ...
            p_g.selectAll('#linein')
                ...
                .attr('y2', d => {
                    ...
                    if (k == 0)
                        return height_ice / (lxBei) - line_scale(Math.log2(Math.abs(parseFloat(d[129])))) / 2
                    return (r[k].n + 1) * height_ice / (lxBei / 2) - height_ice / (lxBei) - line_scale(Math.log2(Math.abs(parseFloat(d[129])))) / 2
                })
                .attr('fill', 'none')
                .attr('stroke', d => {
                    // if (parseFloat(d[129]) > 0)
