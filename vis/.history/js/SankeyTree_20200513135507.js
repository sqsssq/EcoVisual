...
function PaintDecisionLine(Decision, People) {
    d3.csv("data/box_calc.csv", function (RectInnerData) {
        ...
        for (let i in RectInnerData) {
            ...
            for (let j = 1; j < 10; ++j) {
                if (typeof (p[(i - 1).toString() + RectInnerData[i][j].toString() + (i).toString() + RectInnerData[i][j].toString()]) == 'undefined')
                    p[(i - 1).toString() + RectInnerData[i][j].toString() + (i).toString() + RectInnerData[i][j].toString()] = 1;
                else
                    p[(i - 1).toString() + RectInnerData[i][j].toString() + (i).toString() + RectInnerData[i][j].toString()]++;
            }
        }
        console.table(p);
    })
