    ...
    d3.json('data/DT/' + num.toString() + '.json', function (idata) {
        d3.csv('data/box_calc.csv', function (bdata) {
            ...
            for (let i in Cir_1) {
                ...
                .attr('x1', 50 * Math.sin(sita) + width_ice / 2)
                .attr('y1', 50 * Math.cos(sita) + (height_ice / 2 + 10))
                .attr('x2', (50 + 120) * Math.sin(sita) + width_ice / 2)
                .attr('y2', 170 * Math.cos(sita) + (height_ice / 2 + 10))
                .attr('fill', 'none')
                .attr('stroke-width', 5)
                .attr('stroke', '#A9A9A9')
            }
