...
function SunCir(num, lun) {
    d3.json('data/DT/' + num.toString() + '.json', function (idata) {
        d3.csv('data/box_calc.csv', function (bdata) {
            ...
            // console.log(Cir_3)
            //#region 
            var Cir_d = [10, (10 + Redius_in / 4), (10 + Redius_in), 90, (10 + Redius_in *  4)]
            ice_rect
                .selectAll('#iceCir')
                .attr('id', 'iceCir')
                .data(Cir_d)
            ...
            for (let i in Cir_3) {
                ...
                if (!Cir_3[i].tag && Cir_3[i].member.length > 5) {
                    ...
                    ice_rect.append('text')
                        .attr("text-anchor", "middle") //字体尾部对齐
                        .attr('x', (10 + Redius_in *  4) * Math.sin(sita2) + width_ice / 2)
                        .attr('y', (10 + Redius_in *  4) * Math.cos(sita2) + (height_ice / 2 - 10))
                        .text(Cir_3[i].text)
                        .attr('font-family', 'kaiti')
                        .attr('font-size', 8);
                }
