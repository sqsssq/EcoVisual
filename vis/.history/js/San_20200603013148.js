    ...
    if (n == -1) {
        for (var i in p) {
            ...
            for (var j = 1; j <= 11; ++j) {
                ...
                b = {
                    source: {
                        x: a['y1'] * bei + height - padding.top - 375 + a['n1'] * ii * tt - 10,
                        y: padding.left + a['x1'] * rectStep + 40
                    },
                    target: {
                        x: a['y2'] * bei + height - padding.top - 375 + a['n2'] * iii * ttt - 10,
        ...
        for (var i in p) {
            ...
            for (var j = 1; j <= 11; ++j) {
                ...
                let x1 = a['y1'] * bei + height - padding.top - 375 + a['n1'] * iii * ttt - 10;
                if (a['x1'] == 9 && knum == 1) {
                    x1 = a['y1'] * bei + height - padding.top - 375 + iii * ttt - 10
                }
                // if (a['x1'] == 0) tt = 3 * steplen / 2;
                // if (a['x1'] == 2 || a['x1'] == 3 || a['x1'] == 4 || a['x1'] == 5 || a['x1'] == 9) tt = steplen
