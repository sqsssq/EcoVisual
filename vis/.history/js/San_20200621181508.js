...
var LinePaint = function (path, dia, color) {
    ...
    //     .attr("x1", (d, i) => {
    //         if (d.x1 != 0)
    //             return padding.left + d.x1 * rectStep + 0;
    //     })
    //     .attr("y1", (d, i) => {
    //         if (d.x1 != 0) {
    //             // console.log(d)
    ...
    //     .attr("x1", (d, i) => {
    //         // if (d.x1 != 0)
    //             return padding.left + d.x2 * rectStep + 0;
    //     })
    //     .attr("y1", (d, i) => {
    //         if (d.x2 == 11) {
    //             // console.log(d)
    ...
    //     .attr("x1", (d, i) => {
    //         // if (d.x1 != 0)
    //         return padding.left + d.x1 * rectStep + 0 + rectWidth;
    //     })
    //     .attr("y1", (d, i) => {
    //         // if (d.x1 != 0) {
    //         // console.log(d)
        ...
        for (var i in p) {
            ...
            for (var j = 1; j <= 11; ++j) {
                ...
                b = {
                    source: {
                        x: x1,
                        y: padding.left + a['x1'] * rectStep + 52.5
                    },
                    target: {
                        x: x2,
                        y: padding.left + a['x2'] * rectStep - 35
                    }
                }
                dia_path.push(b)
            }
