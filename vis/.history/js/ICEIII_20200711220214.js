        ...
        d3.csv('data/box_calc.csv', function (bdata) {
            ...
            for (let i in Cir_1) {
                ...
                ice_rect.selectAll('RLine_2')
                    ...
                    .attr('y1', (d, i) => {
                        let sita = Math.PI - (StartAngle * Math.PI * 2 + i * 360 / 304 * Math.PI / 180);
                        return 50 * Math.cos(sita) + (height_ice / 2 );
                    })
                    .attr('x2', (d, i) => {
                        let sita = Math.PI - (StartAngle * Math.PI * 2 + i * 360 / 304 * Math.PI / 180);
                        let cx = 0;
                    ...
                    .attr('y2', (d, i) => {
                        ...
                        if (parseFloat(d['129']) < 0)
                            cx = -cx;
                        return (50 + cx) * Math.cos(sita) + (height_ice / 2 );
                    })
                    .attr('fill', 'none')
                    .attr('stroke', d => {
            ...
            ice_rect.selectAll('RLine_1')
                ...
                .attr('y1', (d, i) => {
                    let sita = Math.PI - (i * 360 / 304 * Math.PI / 180);
                    return 20 * Math.cos(sita) + (height_ice / 2 );
                })
                .attr('x2', (d, i) => {
                    let sita = Math.PI - (i * 360 / 304 * Math.PI / 180);
                    let cx = 0;
                ...
                .attr('y2', (d, i) => {
                    ...
                    if (parseFloat(d['129']) < 0)
                        cx = -cx;
                    return (20 + cx) * Math.cos(sita) + (height_ice / 2 );
                })
                .attr('fill', 'none')
                .attr('stroke', d => {
                    if (parseFloat(d['label']) == 2) {
            ...
            for (let i in Cir_2) {
                ...
                ice_rect.selectAll('RLine_2')
                    ...
                    .attr('y1', (d, i) => {
                        let sita = Math.PI - (StartAngle2 * Math.PI * 2 + i * 360 / 304 * Math.PI / 180);
                        return 90 * Math.cos(sita) + (height_ice / 2 );
                    })
                    .attr('x2', (d, i) => {
                        let sita = Math.PI - (StartAngle2 * Math.PI * 2 + i * 360 / 304 * Math.PI / 180);
                        let cx = 0;
                    ...
                    .attr('y2', (d, i) => {
                        ...
                        if (parseFloat(d['129']) < 0)
                            cx = -cx;
                        return (90 + cx) * Math.cos(sita) + (height_ice / 2 );
                    })
                    .attr('fill', 'none')
                    .attr('stroke', d => {
                        if (parseFloat(d['label']) == 2) {
            ...
            for (let i in Cir_3) {
                ...
                if (!Cir_3[i].tag)
                    ...
                    .attr('y1', (d, i) => {
                        let sita = Math.PI - (StartAngle3 * Math.PI * 2 + i * 360 / 304 * Math.PI / 180);
                        return 130 * Math.cos(sita) + (height_ice / 2 );
                    })
                    .attr('x2', (d, i) => {
                        let sita = Math.PI - (StartAngle3 * Math.PI * 2 + i * 360 / 304 * Math.PI / 180);
                        let cx = 0;
                    ...
                    .attr('y2', (d, i) => {
                        ...
                        if (parseFloat(d['129']) < 0)
                            cx = -cx;
                        return (130 + cx) * Math.cos(sita) + (height_ice / 2 );
                    })
                    .attr('fill', 'none')
                    .attr('stroke', d => {
                        // console.log(d)
            ...
            for (let i in Cir_1) {
                ...
                ice_rect.append('text')
                    ...
                    .attr('y', 50 * Math.cos(sita2) + (height_ice / 2 ))
                    .text(Cir_1[i].text)
                ...
                if (num == 5 && i == 0) {
                    ...
                    .attr('y1', 30 * Math.cos(sita) + (height_ice / 2 ))
                    .attr('x2', (10 + 100) * Math.sin(sita) + width_ice / 2)
                    .attr('y2', 110 * Math.cos(sita) + (height_ice / 2 ))
                    .attr('fill', 'none')
                    .attr('stroke-width', 3)
                    .attr('stroke', '#A9A9A9')
                } else
                    ...
                    .attr('y2', 150 * Math.cos(sita) + (height_ice / 2 ))
                    .attr('fill', 'none')
                    .attr('stroke-width', 3)
                    .attr('stroke', '#A9A9A9')
            }
            ...
            for (let i in Cir_2) {
                ...
                ice_rect.append('text')
                    ...
                    .attr('y', 90 * Math.cos(sita2) + (height_ice / 2 ))
                    .text(Cir_2[i].text)
                    .attr('font-family', 'kaiti')
                    .attr('font-size', 10);
                StartAngle2 += Cir_2[i].member.length / 304
                ...
                ice_rect.append('line')
                    ...
                    .attr('y1', 70 * Math.cos(sita) + (height_ice / 2 ))
                    .attr('x2', (10 + 100) * Math.sin(sita) + width_ice / 2)
                    .attr('y2', 110 * Math.cos(sita) + (height_ice / 2 ))
                    .attr('fill', 'none')
                    .attr('stroke-width', 2)
            ...
            for (let i in Cir_3) {
                ...
                if (!Cir_3[i].tag && Cir_3[i].member.length > 5) {
                    ...
                    ice_rect.append('text')
                        ...
                        .attr('y', 130 * Math.cos(sita2) + (height_ice / 2 ))
                        .text(Cir_3[i].text)
                        .attr('font-family', 'kaiti')
                        .attr('font-size', 8);
                }
                ...
                ice_rect.append('line')
                    ...
                    .attr('y1', 110 * Math.cos(sita) + (height_ice / 2 ))
                    .attr('x2', (50 + 100) * Math.sin(sita) + width_ice / 2)
                    .attr('y2', 150 * Math.cos(sita) + (height_ice / 2 ))
                    .attr('fill', 'none')
                    .attr('stroke-width', 1)
