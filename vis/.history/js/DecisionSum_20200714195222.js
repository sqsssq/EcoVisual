...
function PaintRactIn() {
    // console.log(222)
    d3.json('data/DK/sum.json', function (sdata) {
        d3.csv('data/box_calc.csv', function (bdata) {
                            ...
                            for (let l in sdata[p][i][j][k]) {
                                ...
                                for (let m in sdata[p][i][j][k][l]) {
                                    ...
                                    for (let n in sdata[p][i][j][k][l][m]) {
                                        ...
                                        Cir_3.push({
                                            ...
                                            x3: m,
                                            D3: n,
                                            str: i * 10000000000 + j * 100000000 + k * 1000000 + l * 10000 + m * 100 + n
                                        })
                                ...
                                if (tag) {
                                    ...
                                    Cir_3.push({
                                        ...
                                        x2: k,
                                        D2: l,
                                        str: i * 10000000000 + j * 100000000 + k * 1000000 + l * 10000
                                    });
                                    Cir_3[cnt3]['Decision'][i] = j;
                                    // console.log(1)
                                    Cir_3[cnt3]['Decision'][k] = l;
            ...
            for (let i in pie_data) {
                ...
                PieData.push({
                    value: value,
                    average: value / pie_data[i].member.length,
                    low: l,
                    mid: m,
                    high: h,
                    // x1: 
