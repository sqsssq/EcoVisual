...
var LinePaint = function (path, dia, color) {
    ...
    Line_Name.push(Rect_g.selectAll(".line_r")
        ...
        .attr("x1", (d, i) => {
            if (d.x1 != 0)
                return padding.left + d.x1 * rectStep + 0.5;
        })
        .attr("y1", (d, i) => {
            if (d.x1 != 0) {
                // console.log(d)
        ...
        .attr("x2", (d, i) => {
            if (d.x1 != 0) {
                ...
                if (d.v1 < 0) {
                    len = -len;
                    return padding.left + d.x1 * rectStep + len + 0.5 + rectWidth / 2;
                }
                // if (d.v >= 0)
                // len = linearZ(d.v);
                // else if (d.v <= 0)
                // len = linearF(d.v);
                return padding.left + d.x1 * rectStep + 0.5 + rectWidth / 2;
            }
        })
        .attr("y2", (d, i) => {
            if (d.x1 != 0) {
        ...
        .attr("x1", (d, i) => {
            // if (d.x1 != 0)
                return padding.left + d.x2 * rectStep + 0.5;
        })
        .attr("y1", (d, i) => {
            if (d.x2 == 11) {
                // console.log(d)
        ...
        .attr("x2", (d, i) => {
            if (d.x2 == 11) {
                ...
                if (d.v1 < 0) {
                    len = -len;
                    return padding.left + d.x2 * rectStep + len + 0.5 + rectWidth / 2;
                }
                // if (d.v >= 0)
                // len = linearZ(d.v);
                // else if (d.v <= 0)
                // len = linearF(d.v);
                return padding.left + d.x2 * rectStep + 0.5 + rectWidth / 2;
            }
        })
        .attr("y2", (d, i) => {
            if (d.x2 == 11) {
        ...
        .attr("x1", (d, i) => {
            // if (d.x1 != 0)
                return padding.left + d.x1 * rectStep + 0.5 + rectWidth;
        })
        .attr("y1", (d, i) => {
            // if (d.x1 != 0) {
                // console.log(d)
    ...
    d3.csv("data/box.csv", function (d1) {
        ...
        d3.json('data/ScatterF.json', function (coork) {
            d3.csv("data/box_calc.csv", function (RectInData) {
                ...
                Rect_g = svg.append('g').attr("transform", "translate(" + 0 + "," + 25 + ")")
                ...
                Rect_g.selectAll(".line")
                    ...
                    .append("line")
                    .attr("x1", (d, i) => {
                        return padding.left + d.x * rectStep + 0.5 + rectWidth / 2;
                    })
                    .attr("y1", (d, i) => {
                        // console.log(d)
                        var tt = steplen;
                    ...
                    .attr("x2", (d, i) => {
                        ...
                        // else if (d.v <= 0)
                        // len = linearF(d.v);
                        return padding.left + d.x * rectStep + len + 0.5 + rectWidth / 2;
                    })
                    .attr("y2", (d, i) => {
...
function PaintIn(num) {
    ...
    if (num == 20) coorp = "data/Scatter/20.json";
    d3.csv("data/box.csv", function (d1) {
        d3.json('data/ScatterF.json', function (coor) {
