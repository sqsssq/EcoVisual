...
d3.csv('data/box_calcr.csv', function (Ice_d) {
    ...
    p_g.selectAll('#rr_')
        ...
        .attr('y', d => {
            if (d.n == 0) return 0;
            return (d.n - 1) * height_ice / 4.1 + height_ice / 8.2;
            // return 100
        })
        .attr('x', d => {
            let cnt = 0;
        ...
        .attr('height', d => {
            if (d.n == 0) return height_ice / 8.2;
            else return height_ice / 4.1;
        })
        .attr('width', d => {
    ...
    p_g.selectAll('#rr__')
        ...
        .attr('y', d => {
            // if (d.n == 0) return 0;
            return 3 * height_ice / 4.1 + height_ice / 8.2;
            // return 100
        })
        .attr('x', (d, i) => {
            let cnt = 0;
    ...
    for (var k = 0; k < 33; ++k) {
        ...
        p_g.selectAll('#linein')
            ...
            .attr('y1', d => {
                if (k == 0)
                    return height_ice / 8
                return (r[k].n + 1) * height_ice / 4.1 - height_ice / 8.2
            })
            .attr('x2', (d, i) => {
                // return i / 10;
                var cnt = 0;
