...
function DrawMatrix() {
    d3.csv('data/box_calc.csv').then((data) => {
        ...
        matrixG.selectAll('#mls')
            ...
            .enter()
            .append('line')
            .attr('x1', (d, i) => (i) % 12 * step + rectW / 2)
            .attr('x2', (d, i) => (i) % 12 * step + rectW / 2)
            .attr('y1', (d, i) => parseInt((i) / 12) * step + rectW)
            .attr('y2', (d, i) => parseInt((i) / 12) * step + rectW + (step - rectW))
            .attr('fill', 'none')
            .attr('stroke', 'black')
            .attr('stroke-width', d => sScale(d))
