        ...
        d3.csv('data/jingshouyi.csv').then((rect_data) => {
            d3.csv('data/box_calc_rank.csv').then((box_data) => {
                ...
                for (let i = 0; i < box_data.length; ++i) {
                    let temp = {
                        x: parseFloat(box_data[i][(tx + 1).toString() + '9']) - parseFloat(box_data[i][(tx.toString() + '9')]),
                        y: parseFloat(box_data[i][(ty + 1).toString() + '9']) - parseFloat(box_data[i][(ty).toString() + '9']),
