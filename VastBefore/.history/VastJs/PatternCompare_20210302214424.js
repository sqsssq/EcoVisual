    ...
    d3.csv('data/data_for_line.csv').then(data => {
        d3.csv('data/treatment.csv').then(treat => {
            ...
            $(document).ready(function () {
                ...
                $("#ganttView").append('<select style="position: absolute; top: 355px; left: 30px;" name="select1" id="se" onclick="console.log(this.value)"><option value="1">1</option><option value="2">2</option><option value="3" selected>3</option><option value="4">4</option><option value="5">5</option></select>');
